export const quantityTypeSelector = document.querySelector("#uc-property");
export const unit1Selector = document.querySelector("#unit-1");
export const unit2Selector = document.querySelector("#unit-2");
export const inputBox = document.querySelector("#input_box");
export const outputBox = document.querySelector("#output_box");
...
export const injectUnits = (quantityName) => {
...
export const convert = () => {
    if (quantityTypeSelector.value === "Select a property........." ||
        inputBox.value === "") {
        outputBox.value = "";
        return;
    }
    const scale = quantities[quantityTypeSelector.value];
    let result = ((inputBox.valueAsNumber * scale[unit1Selector.value]) /
